# Lancement robuste Job B: dept 93 (special case - single dept)
...
Write-Host ""
Write-Host "==== LANCEMENT JOB B: dept 93 ====" -ForegroundColor Cyan
Write-Host ""
...
$argsStr = "scripts/enrich_finess_dept.py,--departements,93,--out-dir,/tmp/outputs"
...
Write-Host "[LAUNCH] Demarrage dept 93..." -ForegroundColor Yellow
