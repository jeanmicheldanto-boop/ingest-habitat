# Lancement robuste Job A: depts 56-60
...
Write-Host ""
Write-Host "==== LANCEMENT JOB A: depts 56-60 ====" -ForegroundColor Cyan
Write-Host ""
...
$argsStr = "scripts/enrich_finess_dept.py,--departements,56,57,58,59,60,--out-dir,/tmp/outputs"
...
Write-Host "[LAUNCH] Demarrage depts 56,57,58,59,60..." -ForegroundColor Yellow
