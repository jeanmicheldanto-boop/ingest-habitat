# Lancement robuste Job B: depts 66-70
...
Write-Host ""
Write-Host "==== LANCEMENT JOB B: depts 66-70 ====" -ForegroundColor Cyan
Write-Host ""
...
$argsStr = "scripts/enrich_finess_dept.py,--departements,66,67,68,69,70,--out-dir,/tmp/outputs"
...
Write-Host "[LAUNCH] Demarrage depts 66,67,68,69,70..." -ForegroundColor Yellow
